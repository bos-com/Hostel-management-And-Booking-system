...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>NEW GENERATION HOSTEL,</p>
				<p>Bugema 34km along zirobwe road,<br>Kampala,<br>Uganda.</p>
				<p>0777804578</p>
			</address>
			<span><img alt="" src="assets/img/20.png"></span>
		</header>
		<article>
			<h1></h1>
			<address >
			...
			<table class="meta">
				...
				<tr>
    <th><span>Paid (UGX)</span></th>
    <td>
        <div style="display:flex; align-items:center;">
            <span style="margin-right:5px;">UGX</span>
            <input 
                type="number" 
                name="paid_amount" 
                step="0.01" 
                ...
                value="<?php echo isset($paid_amount) ? $paid_amount : ''; ?>" 
            />
        </div>
    </td>
</tr>
<tr>
    <th><span>balance(UGX)</span></th>
    <td>
        <div style="display:flex; align-items:center;">
            <span style="margin-right:5px;">UGX</span>
            <input 
		...
		<aside>
			...
			<div >
				<palign="center">Email :- info@NEW GENERATIONhostel.com || Web :- www.NEW GENERATIONhostel.com || Phone :- (+256) 777804578 </p>
			</div>
		</aside>
	</body>
</html>
